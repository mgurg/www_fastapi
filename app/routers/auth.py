...
from services.auth import user_exists, create_user, authenticate_user, user_uuid_exists
...
async def verify(token: str, db: get_db = Depends()):
    ...
    user = user_uuid_exists(db, payload['sub'])
